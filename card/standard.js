...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			qinglong_info:'装备此牌，你可以将一张【桃】当作【酒】使用。',
			qinglong_info_guozhan:'装备此牌，你可以将一张【桃】当作【酒】使用。',
			...
			fangtian_info:'装备此牌，其他角色出牌阶段开始时，你可与其拼点。若你赢，视为你对其使用一张【决斗】；若你没赢，视为其对你使用一张【决斗】。',
			fangtian_info_guozhan:'装备此牌，其他角色出牌阶段开始时，你可与其拼点。若你赢，视为你对其使用一张【决斗】；若你没赢，视为其对你使用一张【决斗】。',
