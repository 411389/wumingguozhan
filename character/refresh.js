...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
			...
			"new_yajiao":{
				...
				content:function (){
					...
					if(result.targets){
						...
						if(!event.same) player.chooseToDiscard(true,'h');
					}
				},
				ai:{
					effect:{
		...
		translate:{
			...
			"new_yajiao":"涯角",
			"new_yajiao_info":"每当你于回合外使用或打出手牌时，你可以亮出牌堆顶的一张牌，并将其交给一名角色。若此牌与你此次使用或打出的牌类别不同，则你弃置一张手牌。",
			"new_liyu":"利驭",
			...
			xunxun_info:'摸牌阶段，你可以观看牌堆顶的四张牌，然后将其中的两张牌置于牌堆顶，其余的牌则置于牌堆底。',
